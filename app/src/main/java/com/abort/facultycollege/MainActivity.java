...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        userRef= FirebaseDatabase.getInstance().getReference(Common.FACULTYREF);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                            ...
                            dialog.dismiss();
                            Toast.makeText(MainActivity.this, "You Are Not Faculty . Contact admin", Toast.LENGTH_SHORT).show();
